...
open this file, =M-x xcl-transclude-mode=, cursor over a transclusion
directive, and =C-c E=
...
** webserver
   ...
   the transclusion engine is a nodejs webserver; see
   [[https://github.com/whacked/xcl][transclusion server]] for install +
   setup; launch it from another terminal
